...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
 ...
 Semantic html element should clearly describe the meaning to people and browser.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

HTML elements with display:inline-block can have their own width and height.
...
Git records changes to repository. So we always can go back to the previous versions of the product.
